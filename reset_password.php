...
if (isset($_GET['token']) && isset($_POST["submit"])) {
    $set_data_obj->update_password($_POST, $_GET['token']);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-7">
                ...
                <form method="post">
                    <div class="col-md-7">
                        ...
                        <div>
                            <input type="password" placeholder="Type your new pasword" class="form-control login-fields" required name="password" />
                        
                        </div>
                        <br/>
                        <div>
                            <input type="password" placeholder="Confirm Your Password" class="form-control login-fields" required name="confirm_password" />
                           
                        </div>


                        <input type="submit" class="btn login-btn" id="login" name="submit" value='Submit' />
                        <br />
